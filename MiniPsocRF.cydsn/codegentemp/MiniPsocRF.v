...
module ADC_DelSig_v3_20_1 (
	...
	cy_clock_v1_0
		#(.id("10c31d0d-9273-40ee-acaf-9a2eb7cf9943/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("10c31d0d-9273-40ee-acaf-9a2eb7cf9943/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("6250000000"),
		  .is_direct(0),
...
module SPI_Master_v2_50_3 (
	...
	cy_clock_v1_0
		#(.id("ecfebc6b-8467-4b32-b1ca-a41b648aff31/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("6f353aeb-0bcd-4f85-b432-59e6786a35b1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4bdce3b9-0824-4dbc-8516-d23c07b3a913"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b52f20ee-dac5-4909-aee0-1c66dbbb115e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("73d1803a-f45f-4068-8f7a-20d89f987084"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__ADC_Input_net;
	wire [0:0] tmpFB_0__ADC_Input_net;
	wire [0:0] tmpIO_0__ADC_Input_net;
	wire [0:0] tmpINTERRUPT_0__ADC_Input_net;
	electrical [0:0] tmpSIOVREF__ADC_Input_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		ADC_Input
		 (.oe(tmpOE__ADC_Input_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ADC_Input_net[0:0]}),
		  .analog({Net_35}),
		  .io({tmpIO_0__ADC_Input_net[0:0]}),
		  .siovref(tmpSIOVREF__ADC_Input_net),
		  .interrupt({tmpINTERRUPT_0__ADC_Input_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ADC_Input_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DAC_Output_net;
	wire [0:0] tmpFB_0__DAC_Output_net;
	wire [0:0] tmpIO_0__DAC_Output_net;
	wire [0:0] tmpINTERRUPT_0__DAC_Output_net;
	electrical [0:0] tmpSIOVREF__DAC_Output_net;

	cy_psoc3_pins_v1_10
		#(.id("f0a64fc6-ec00-4cff-bb6e-de856206b8df"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DAC_Output
		 (.oe(tmpOE__DAC_Output_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DAC_Output_net[0:0]}),
		  .analog({Net_73}),
		  .io({tmpIO_0__DAC_Output_net[0:0]}),
		  .siovref(tmpSIOVREF__DAC_Output_net),
		  .interrupt({tmpINTERRUPT_0__DAC_Output_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	cy_psoc3_pins_v1_10
		#(.id("45cef156-78da-4b55-8e1a-2fd278096e4f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
